...
class PluginManagerTestCase(unittest.TestCase):
    ...
    def test_generate_payload_first_plugin(self):
        ...
        self.plugin1.supports.assert_called_once_with(None, None, context)
        self.plugin1.generate_payload.assert_called_once_with(None, None, context)
    ...
    def test_generate_payload_second_plugin(self):
        ...
        self.plugin2.supports.assert_called_once_with(None, None, context)
        self.plugin2.generate_payload.assert_called_once_with(None, None, context)
